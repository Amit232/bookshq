var bookAppAdmin = angular.module('bookAppAdmin', ['ui.router','ngCookies','ngSanitize','timer','ngImgCrop','angularFileUpload','summernote']);
var interval;
var validateOptions= {
  errorElement: 'em',
  errorClass: 'invalid',
    ...
    if($('#normalProduct').valid()&&product!=''){
        ...
        // {
            ...
            $upload.upload({
                ...
                file: $scope.files,
                fields: {'product':product,'id_admin':$cookies.id_admin,'description':product.description},
