...
public function getOrders($id_user='')
  ...
  {
    global $db;
    $q_t_items= "SELECT p.id_product,p.name,p.pic,p.pic_name,COUNT(t.product_id_product) as product_count FROM product as p LEFT JOIN sub_transaction as t ON t.product_id_product=p.id_product GROUP BY p.id_product ORDER BY product_count DESC LIMIT $limit";
